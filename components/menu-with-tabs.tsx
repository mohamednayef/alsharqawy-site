...
const menuData = {
  ...
  meals: [
    ...
    {
      id: 125,
      name: "وجبة فيليه مع الرز",
      sizes: [
        { size: "سلطة، طحينة، كانز+يس سشيب سي بسب سب سيب ", price: 250 },
      ],
      image: "/liver01.jpg",
    },
    {
      id: 126,
      name: "وجبة بانيه مع الرز",
      sizes: [
        { size: "المكونات: سلطة، طحينة، كانز", price: 250 },
      ],
      image: "/liver01.jpg",
